...
class arrayPractice {
    public static void main(String[] args) {
        ...
        */
        /*DataStructures.arrayPractice DataStructures.arrayPractice = new DataStructures.arrayPractice();
        List<String> result = DataStructures.arrayPractice.fizzBuzz(1000);
