...
//*****************************************************************************************
		  //DataStructures.arrayPractice arrPrac = new DataStructures.arrayPractice();
		    //DataStructures.hashTablePrac hashPrac = new DataStructures.hashTablePrac(50);
		    //DataStructures.LinkedList linList = new DataStructures.LinkedList();
		  	//DataStructures.Stack newStack = new DataStructures.Stack();
		  	//DataStructures.StackArr newStack = new DataStructures.StackArr();
		  	//DataStructures.Queue newQueue = new DataStructures.Queue();
...
//*****************************************************************************************
		  //DataStructures.Graph Implementation
		 /* DataStructures.Graph graph = new DataStructures.Graph();
		  graph.addVertex(0);
		  graph.addVertex(1);
		  graph.addVertex(2);
		  graph.addVertex(3);
